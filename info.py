...
BOT_TOKEN = environ.get('BOT_TOKEN', "6757671040:AAFO49zI8x3mT6glKU_8OKo4aPuoWlmw4uA") 
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Vasu:Teluguzone@cluster0.cf3e2zg.mongodb.net/?retryWrites=true&w=majority")
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002127374415')
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else False
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DATABASE_URI)

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001611267555'))
